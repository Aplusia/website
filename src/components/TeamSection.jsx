...
import jambaPhoto from "../assets/jamba_crop_optimized.jpg";
import juanPhoto from "../assets/juan_crop_optimized.jpg";
import patriciaPhoto from "../assets/patricia_crop_optimized.jpg";
import paulynaPhoto from "../assets/paulyna_crop_optimized.jpg";
import teamPhoto from "../assets/team_optimized.jpg";
...
const TEAM_MEMBERS = [
	{
		...
		social: {
			linkedin: "https://www.linkedin.com/in/dr-christoph-wichmann-47119b215/",
			github: "",
			twitter: "",
		},
		email: {
	...
	},
	{
		...
		social: {
			linkedin: "https://www.linkedin.com/in/juan-luis-restrepo-7526611a3/",
			github: "",
			twitter: "",
		},
		image: juanPhoto,
	},
	{
		...
		role: "Consultant",
		expertise: "Mass Spectrometry | Large Language Models",
		bio: [
	...
	},
	{
		...
		expertise: "Bioinformatics | Proteomics | Transcriptomics",
		bio: [
		...
		social: {
			linkedin: "https://www.linkedin.com/in/constantin-ammar-987084187/",
			github: "",
			twitter: "",
		},
		image: constiPhoto,
								...
								{(selectedMember.email ||
									...
									<div className="mt-8 pt-8 border-t border-gray-200">
										...
										<div className="flex flex-wrap gap-4">
											{selectedMember.email && (
												<MailCopy
													user={selectedMember.email.user}
													domain={selectedMember.email.domain}
												/>
											)}
											{selectedMember.social.linkedin && (
												<a
